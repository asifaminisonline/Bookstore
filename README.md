...
Clone this repository by using the command line : git clone https://github.com/asifaminisonline/Bookstore.git
...
This project is [MIT](https://github.com/asifaminisonline/Bookstore/blob/Initialize/LICENSE.md) licensed.
